...
module LogicalRelations where
  ...
  _~v_ {Γ} {α} t d = Γ ⊢v t ≡ ⊢nv-embed d
  _~v_ {Γ} {Bool} b d = Γ ⊢v b ≡ ⊢nv-embed d
  _~v_ {Γ} {One} t d = True
  ...
  ~c-monotonicity : 
    ...
    {g : Ren Γ' Γ''} 
    → f ~e e 
    → subst-rename g f ~e env-rename g e
  ...
  ~v-monotonicity {Γ} {Γ'} {α} {f} {t} {d} r = 
    ≡-trans (≡-renamecong-v r) (⊢nv-embed-naturality d)
  ~v-monotonicity {Γ} {Γ'} {Bool} {f} {b} {d} r = 
    ≡-trans (≡-renamecong-v r) (⊢nv-embed-naturality d)
  ~v-monotonicity {Γ} {Γ'} {One} r = 
    void
  ...
  ~v-invariance {Γ} {α} {t} {t'} {d} r p = 
    ≡-trans (≡-sym p) (r)
  ~v-invariance {Γ} {Bool} {t} {t'} {d} r p = 
    ≡-trans (≡-sym p) (r)
  ~v-invariance {Γ} {One} r p = 
    void
  ...
  reflect-v-lem {Γ} {α} t = 
    ≡-refl
  reflect-v-lem {Γ} {Bool} t = 
    ≡-refl
  reflect-v-lem {Γ} {One} t = 
    void
  ...
  reify-v-lem {Γ} {α} t d r = 
    r
  reify-v-lem {Γ} {Bool} t d r = 
    r
  reify-v-lem {Γ} {One} t d r = 
    η⋆
  ...
  ~v-fundamental-lemma s e ⋆ r = 
    void
  ~v-fundamental-lemma s e true r = 
    ≡-refl
  ~v-fundamental-lemma s e false r = 
    ≡-refl
  ~v-fundamental-lemma {Γ} {Γ'} {σ ⇀ τ} s e (lam t) r = λ {Γ''} f' {u} {d} r' → 
    ~p-invariance 
      {t' = (app (lam (⊢p-rename (wk₂ f') (subst-p (lift s) t))) u)} 
      {d = (⟦ t ⟧p (env-extend (λ {σ'} x → ⟦⟧-rename {σ'} f' (e x)) d))} 
      (~p-invariance 
        {t = subst-p (ext-subst (subst-rename f' s) u) t} 
