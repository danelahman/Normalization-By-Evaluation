...
module Presheaves where
  ...
  ⊢p-rename-id-lem (app t u) = 
    ...
    ≅〈 cong2 app (⊢v-rename-id-lem t) (⊢v-rename-id-lem u) 〉 
      app t u 
    ∎
  ⊢p-rename-id-lem (lookup t u) = 
      lookup (⊢p-rename id-ren t) (⊢p-rename id-ren u) 
    ≅〈 cong2 lookup (⊢p-rename-id-lem t) (⊢p-rename-id-lem u) 〉
      lookup t u 
    ∎
  ⊢p-rename-id-lem (update0 t) = 
      update0 (⊢p-rename id-ren t)
    ≅〈 cong update0 (⊢p-rename-id-lem t) 〉
      update0 t
    ∎
  ⊢p-rename-id-lem (update1 t) = 
      update1 (⊢p-rename id-ren t)
    ≅〈 cong update1 (⊢p-rename-id-lem t) 〉
      update1 t
    ∎
  ...
  ⊢p-rename-comp-lem {Γ} {Γ'} {Γ''} {σ} {f} {g} (app t u) = 
    ...
    ∎
  ⊢p-rename-comp-lem {Γ} {Γ'} {Γ''} {σ} {f} {g} (lookup t u) = 
      lookup (⊢p-rename g (⊢p-rename f t)) (⊢p-rename g (⊢p-rename f u))
    ≅〈 cong2 lookup (⊢p-rename-comp-lem t) (⊢p-rename-comp-lem u) 〉
      lookup (⊢p-rename (comp-ren g f) t) (⊢p-rename (comp-ren g f) u)
    ∎
  ⊢p-rename-comp-lem {Γ} {Γ'} {Γ''} {σ} {f} {g} (update0 t) = 
      update0 (⊢p-rename g (⊢p-rename f t))
    ≅〈 cong update0 (⊢p-rename-comp-lem t) 〉
      update0 (⊢p-rename (comp-ren g f) t)
    ∎
  ⊢p-rename-comp-lem {Γ} {Γ'} {Γ''} {σ} {f} {g} (update1 t) = 
      update1 (⊢p-rename g (⊢p-rename f t))
    ≅〈 cong update1 (⊢p-rename-comp-lem t) 〉
      update1 (⊢p-rename (comp-ren g f) t)
    ∎
  ...
  ⊢np'-rename f (update0NP t) = update0NP (⊢np''-rename f t)
  ⊢np'-rename f (update1NP t) = update1NP (⊢np''-rename f t)
  ...
  ⊢av-rename-id-lem (proj₂AV t) = 
    ...
    ≅〈 cong proj₂AV (⊢av-rename-id-lem t) 〉
      proj₂AV t 
    ∎
  ⊢np'-rename-id-lem (update0NP t) = 
      update0NP (⊢np''-rename id-ren t)
    ≅〈 cong update0NP (⊢np''-rename-id-lem t) 〉
      update0NP t
    ∎
  ⊢np'-rename-id-lem (update1NP t) = 
      update1NP (⊢np''-rename id-ren t)
    ≅〈 cong update1NP (⊢np''-rename-id-lem t) 〉
      update1NP t
    ∎
  ...
  ⊢np''-rename-id-lem (toNP t u) = 
    ...
    ≅〈 cong2 toNP (⊢ap-rename-id-lem t) (trans (cong (λ (x : Ren _ _) → ⊢np-rename x u) (iext (λ σ → ext (λ x → wk₂-id-lem x)))) (⊢np-rename-id-lem u)) 〉
      toNP t u
    ∎
  ⊢np-rename-id-lem (lookupNP t u) = 
      lookupNP (⊢np'-rename id-ren t) (⊢np'-rename id-ren u)
    ≅〈 cong2 lookupNP (⊢np'-rename-id-lem t) (⊢np'-rename-id-lem u) 〉
      lookupNP t u
    ∎
  ...
  ⊢nv-rename-comp-lem {Γ} {Γ'} {Γ''} {σ ⇀ τ} {f} {g} (fnNV t) = 
    ...
    ∎
  ⊢np-rename-comp-lem {Γ} {Γ'} {Γ''} {σ} {f} {g} (lookupNP t u) = 
      lookupNP (⊢np'-rename g (⊢np'-rename f t)) (⊢np'-rename g (⊢np'-rename f u))
    ≅〈 cong2 lookupNP (⊢np'-rename-comp-lem t) (⊢np'-rename-comp-lem u) 〉
      lookupNP (⊢np'-rename (comp-ren g f) t) (⊢np'-rename (comp-ren g f) u)
    ∎
  ⊢np'-rename-comp-lem {Γ} {Γ'} {Γ''} {σ} {f} {g} (update0NP t) = 
      update0NP (⊢np''-rename g (⊢np''-rename f t))
    ≅〈 cong update0NP (⊢np''-rename-comp-lem t) 〉
      update0NP (⊢np''-rename (comp-ren g f) t)
    ∎
  ⊢np'-rename-comp-lem {Γ} {Γ'} {Γ''} {σ} {f} {g} (update1NP t) = 
      update1NP (⊢np''-rename g (⊢np''-rename f t))
    ≅〈 cong update1NP (⊢np''-rename-comp-lem t) 〉
      update1NP (⊢np''-rename (comp-ren g f) t)
    ∎
  ...
  ⊢np'-embed (update0NP t) = update0 (⊢np''-embed t)
  ⊢np'-embed (update1NP t) = update1 (⊢np''-embed t)
