...
module Soundness where
  ...
  *-strength-soundness : 
  ...
  soundness-v .(lam t) .(lam t') (conglam {Γ} {σ} {τ} {t} {t'} p) q = λ r → 
  ...
  soundness-v .(proj₂ (pair t u)) u (β×₂ {Γ} {σ₁} {σ} {t}) q = 
    ≈-fundamental-lemma u q
  soundness-v {Γ} {Γ'} {One} {e} {e'} t .⋆ η⋆ q with ⟦ t ⟧v e
  soundness-v {Γ} {Γ'} {One} t .⋆ η⋆ q | ⋆ = refl
  soundness-v t .(pair (proj₁ t) (proj₂ t)) η× q = 
    ≈-fundamental-lemma t q
  soundness-v {Γ} {Γ'} {σ ⇀ τ} {e} {e'} .(lam (app (⊢v-rename (λ {σ} → Tl) u) (var Hd))) u η⇀ p = λ {Γ''} {h} {d} {d'} q → 
    ≈T-trans 
  ...
  soundness-p {Γ} {Γ'} {τ} {e} {e'} .(subst-p (ext-subst var u) t) .(app (lam t) u) (β⇀ {.Γ} {σ} {.τ} {t} {u}) q = 
    ≈T-trans 
  ...
  soundness-p (if true then t else u) .t if-true q = 
    if-true (≈T-fundamental-lemma t q) (≈T-fundamental-lemma u q)
  soundness-p (if false then t else u) .u if-false q = 
    if-false (≈T-fundamental-lemma u q) (≈T-fundamental-lemma t q)
  ...
  *-strength-soundness t u p (if-true q q') r = 
    if-true (*-strength-soundness t u p q r) (*-strength-soundness t u p q' r)
  *-strength-soundness t u p (if-false q q') r = 
    if-false (*-strength-soundness t u p q r) (*-strength-soundness t u p q' r)
