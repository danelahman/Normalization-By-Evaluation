...
module PartialEquivalenceLemmas where
  ...
  ≈-monotonicity {Γ} {Γ'} {α} p = 
    ≡-renamecong-nv p
  ≈-monotonicity {Γ} {Γ'} {Bool} p = 
    ≡-renamecong-nv p
  ≈-monotonicity {Γ} {Γ'} {One} p = 
    refl
  ...
  ≈-fundamental-lemma ⋆ p = 
    refl
  ≈-fundamental-lemma true p = 
    ≡-refl
  ≈-fundamental-lemma false p = 
    ≡-refl
  ≈-fundamental-lemma (lam {σ} {τ} t) p = λ {Γ''} {f} {d} {d'} q → 
  ...
  ≈-*-strength-fundamental-lemma t (if-true p q) r = 
    if-true 
      (≈-*-strength-fundamental-lemma t p r) 
      (≈-*-strength-fundamental-lemma t q r)
  ≈-*-strength-fundamental-lemma t (if-false p q) r = 
    if-false 
      (≈-*-strength-fundamental-lemma t p r) 
      (≈-*-strength-fundamental-lemma t q r)
  ...
  *≈-*-strength-fundamental-lemma {Γ} {Γ'} {σ} {τ} {ρ} {e} {e'} {t} {u} (or-associativity p p' p'') q = 
    or-associativity 
      ...
      (*≈-*-strength-fundamental-lemma {Γ} {Γ'} {σ} {τ} {ρ} {e} {e'} {t} {u} p' q)
      (*≈-*-strength-fundamental-lemma {Γ} {Γ'} {σ} {τ} {ρ} {e} {e'} {t} {u} p'' q)
  *≈-*-strength-fundamental-lemma {Γ} {Γ'} {σ} {τ} {ρ} {e} {e'} {t} {u} (if-true p p') q = 
    if-true 
      (*≈-*-strength-fundamental-lemma {Γ} {Γ'} {σ} {τ} {ρ} {e} {e'} {t} {u} p q) 
      (*≈-*-strength-fundamental-lemma {Γ} {Γ'} {σ} {τ} {ρ} {e} {e'} {t} {u} p' q)
  *≈-*-strength-fundamental-lemma {Γ} {Γ'} {σ} {τ} {ρ} {e} {e'} {t} {u} (if-false p p') q = 
    if-false
      (*≈-*-strength-fundamental-lemma {Γ} {Γ'} {σ} {τ} {ρ} {e} {e'} {t} {u} p q) 
      (*≈-*-strength-fundamental-lemma {Γ} {Γ'} {σ} {τ} {ρ} {e} {e'} {t} {u} p' q)
  ...
  reify-cong-v {Γ} {α} p = 
    p
  reify-cong-v {Γ} {Bool} p = 
    p
  reify-cong-v {Γ} {One} p = 
    ≡-refl
  reify-cong-v {Γ} {σ₁ ∧ σ₂} p = 
    congpair (reify-cong-v (fst p)) (reify-cong-v (snd p))
  reify-cong-v {Γ} {σ ⇀ τ} p = 
    conglam (reify-cong-p (p (reflect-cong-v {Γ :: σ} {σ} refl)))
  ...
  reify-cong-p (if-true p q) = 
    ≡-trans if-true (reify-cong-p p)
  reify-cong-p (if-false p q) = 
    ≡-trans if-false (reify-cong-p p)

  reflect-cong-v {Γ} {α} refl = 
    ≡-refl
  reflect-cong-v {Γ} {Bool} refl = 
    ≡-refl
  reflect-cong-v {Γ} {One} p = 
    refl
  ...
  ⟦⟧-rename-id-lem' {α} d d' p = 
    ≡-trans 
      (≅2≡-nv (⊢nv-rename-id-lem d)) 
      p
  ⟦⟧-rename-id-lem' {Bool} d d' p = 
    ≡-trans 
      (≅2≡-nv (⊢nv-rename-id-lem d)) 
      p
  ⟦⟧-rename-id-lem' {One} d ⋆ p = 
    refl
  ...
  ⟦⟧-rename-comp-lem' {Γ} {Γ'} {Γ''} {α} {f} {g} {d} {d'} p = 
    ≡-trans 
      (≡-renamecong-nv p) 
      (≡-sym (≅2≡-nv (⊢nv-rename-comp-lem d')))
  ⟦⟧-rename-comp-lem' {Γ} {Γ'} {Γ''} {Bool} {f} {g} {d} {d'} p = 
    ≡-trans 
      (≡-renamecong-nv p) 
      (≡-sym (≅2≡-nv (⊢nv-rename-comp-lem d')))

  ⟦⟧-rename-comp-lem' {Γ} {Γ'} {Γ''} {One} p = 
    refl
  ...
  *-strength-leaf-lem' .(T-if trueNV d d') .d'' (if-true {d} {d'} {d''} {d'''} p p') q = 
    if-true (*-strength-leaf-lem' d d'' p q) (*-strength-leaf-lem' d' d''' p' q)
  *-strength-leaf-lem' .(T-if falseNV d d') .d'' (if-false {d} {d'} {d''} {d'''} p p') q = 
    if-false (*-strength-leaf-lem' d' d'' p q) (*-strength-leaf-lem' d d''' p' q)
  ...
  *-rename-env-lem u .(T-if trueNV d d') .d'' (if-true {d} {d'} {d''} {d'''} p p') q = 
    if-true (*-rename-env-lem u d d'' p q) (*-rename-env-lem u d' d''' p' q)
  *-rename-env-lem u .(T-if falseNV d d') .d'' (if-false {d} {d'} {d''} {d'''} p p') q = 
    if-false (*-rename-env-lem u d' d'' p q) (*-rename-env-lem u d d''' p' q)
  ...
  rename-env-lem-v ⋆ p = 
    refl
  rename-env-lem-v true p = 
    ≡-refl
  rename-env-lem-v false p = 
    ≡-refl
  rename-env-lem-v {Γ} {Γ'} {Γ''} {σ ⇀ τ} {f} {e} {e'} (lam t) p = λ {Γ'''} {h} {d} {d'} q → 
    ≈T-trans 
      (≈T-fundamental-lemma 
        t 
        (λ {σ'} x → env-extend-rename-wk₂-lem {e = env-rename h e} {e' = env-rename h e} (≈-refl {Γ'''} {σ} q) (≈e-monotonicity (≈e-refl p)) x)) 
      (rename-env-lem-p t (≈e-extend-lem (≈e-monotonicity p) q))
  ...
  rename-env-lem-p (if b then t else u) p = 
    congif (rename-env-lem-v b p) (rename-env-lem-p t p) (rename-env-lem-p u p) --congif (rename-env-lem-p t p) (rename-env-lem-p u p)
  ...
  ⟦⟧v-naturality' true p = 
    ≡-refl
  ⟦⟧v-naturality' false p = 
    ≡-refl
  ⟦⟧v-naturality' {Γ} {Γ'} {Γ''} {σ ⇀ τ} {e} {e'} {f} (lam t) p = λ {Γ'''} q → 
  ...
  *-env-extend-subst-lem {Γ} {Γ'} {Γ''} {σ} {σ'} {s} {e} {e'} u .(T-if trueNV d d') .d'' (if-true {d} {d'} {d''} {d'''} p p') q = 
    if-true 
      (*-env-extend-subst-lem {Γ} {Γ'} {Γ''} {σ} {σ'} {s} {e} {e'} u d d'' p q) 
      (*-env-extend-subst-lem {Γ} {Γ'} {Γ''} {σ} {σ'} {s} {e} {e'} u d' d''' p' q)
  *-env-extend-subst-lem {Γ} {Γ'} {Γ''} {σ} {σ'} {s} {e} {e'} u .(T-if falseNV d d') .d'' (if-false {d} {d'} {d''} {d'''} p p') q = 
    if-false 
      (*-env-extend-subst-lem {Γ} {Γ'} {Γ''} {σ} {σ'} {s} {e} {e'} u d' d'' p q) 
      (*-env-extend-subst-lem {Γ} {Γ'} {Γ''} {σ} {σ'} {s} {e} {e'} u d d''' p' q)
  ...
  env-extend-subst-lem-v ⋆ p = 
    refl
  env-extend-subst-lem-v true p = 
    ≡-refl
  env-extend-subst-lem-v false p = 
    ≡-refl
  env-extend-subst-lem-v {Γ} {Γ'} {Γ''} {σ ⇀ τ} {s} {e} {e'} (lam t) p = λ {Γ'''} {h} {d} {d'} q → 
    ≈T-trans 
      (≈T-fundamental-lemma 
        t 
        (≈e-trans 
  ...
  **-strength-lem' {Γ} {Γ'} {σ} {τ} {ρ} {e} {e'} {t} .(T-if trueNV d d') .d'' d'''' (if-true {d} {d'} {d''} {d'''} p p') q r = 
    if-true (**-strength-lem' {t = t} d d'' d'''' p q r) (**-strength-lem' {Γ} {Γ'} {σ} {τ} {ρ} {e} {e'} {t = t} d' d''' d'''' p' q r)
  **-strength-lem' {Γ} {Γ'} {σ} {τ} {ρ} {e} {e'} {t} .(T-if falseNV d d') .d'' d'''' (if-false {d} {d'} {d''} {d'''} p p') q r = 
    if-false (**-strength-lem' {t = t} d' d'' d'''' p q r) (**-strength-lem' {Γ} {Γ'} {σ} {τ} {ρ} {e} {e'} {t = t} d d''' d'''' p' q r)
  ...
  **-strength-lem {Γ} {Γ'} {σ} {σ'} {τ} {e} {e'} {u} {v} (T-or (T-or d d') d'') (T-or d''' (T-or d'''' d''''')) (or-associativity p p' p'') q = 
    or-associativity 
      ...
      (**-strength-lem {u = u} {v = v} d' d'''' p' q) 
      (**-strength-lem {u = u} {v = v} d'' d''''' p'' q)
  **-strength-lem {Γ} {Γ'} {σ} {σ'} {τ} {e} {e'} {u} {v} .(T-if trueNV d d') .d'' (if-true {d} {d'} {d''} {d'''} p p') q = 
    if-true 
      (**-strength-lem {u = u} {v = v} d d'' p q) 
      (**-strength-lem {u = u} {v = v} d' d''' p' q)
  **-strength-lem {Γ} {Γ'} {σ} {σ'} {τ} {e} {e'} {u} {v} .(T-if falseNV d d') .d'' (if-false {d} {d'} {d''} {d'''} p p') q = 
    if-false 
      (**-strength-lem {u = u} {v = v} d' d'' p q) 
      (**-strength-lem {u = u} {v = v} d d''' p' q)
